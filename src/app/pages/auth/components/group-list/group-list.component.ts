...
import { AddUserGroupsDialogComponent } from '../add-user-groups-dialog/add-user-groups-dialog.component';
...
export class GroupListComponent  implements OnInit{
  ...
  openAddUserDialog(): void {
    const dialogRef = this.dialog.open(AddUserGroupsDialogComponent, {
      width: '500px',
      disableClose: true
    });
